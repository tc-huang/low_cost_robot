...
def main() -> None:
    ...
    with mujoco.viewer.launch_passive(
        ...
        while viewer.is_running():
            ...
            data.mocap_pos[mocap_id, 0:2] = circle(data.time, 0.01, 0.05, 0.0, 0.5)
            ...
            # Valid names: ['gripper_moving_1', 'gripper_static_1', 'link1_1', 'link2_1', 'link3_1', 'link4_1', 'target', 'world']"
            print(f"\033[H\033[2Jworld_pose: {read_ee_pos('world')}")
            print(f"box_pose: {read_ee_pos('target')}")
            print(f"model.body: {model.body}")
